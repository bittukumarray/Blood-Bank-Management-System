# Generated by Django 2.1 on 2018-11-06 16:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pathlab', models.CharField(choices=[('Chennai', 'Chennai'), ('Bangalore', 'Bangalore'), ('Patna', 'Patna'), ('Mumbai', 'Mumbai'), ('Hyderabad', 'Hyderabad'), ('Kolkata', 'Kolkata'), ('Delhi', 'Delhi'), ('Jamshedpur', 'Jamshedpur')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='UserAddress',
